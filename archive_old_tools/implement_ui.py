...
# We need to find the start of <!-- Omset Hari Ini -->
# and the end of the <!-- Laba Bersih --> div.

start_marker = '<!-- Omset Hari Ini -->'
# Find Target Gaji marker, since it comes right after Laba Bersih
end_marker = '<!-- Target Gaji (CTS) - Keeping original format with donut chart but matching height -->'
...
with open('templates/dashboard.html', 'w', encoding='utf-8') as f:
    f.write(html)
print("Successfully injected the new UI!")
