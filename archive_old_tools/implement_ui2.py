...
# Let's find the container block that holds Omset, Laba Kotor, Total Beban, Laba Bersih
# They are inside something like:
# <div style="display: flex; gap: ...">
#   <!-- Omset Hari Ini --> ...

start_match = re.search(r'<!-- Omset Hari Ini -->', html)
end_match = re.search(r'<!-- Target Gaji \(CTS\)', html)
...
if start_match and end_match:
    ...
    # Same premium_cards string as before
    premium_cards = """<!-- Omset Hari Ini -->
    ...
    html = html[:start_idx] + premium_cards + html[end_idx:]
    with open('templates/dashboard.html', 'w', encoding='utf-8') as f:
        f.write(html)
    print("UI applied safely!")
else:
    print("Could not find start/end via regex.")
