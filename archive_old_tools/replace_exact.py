...
# Instead of relying on exact comments, let's regex match the 4 blocks
# Each block starts with <div style="flex: 1; min-width: 240px; and ends with </div>\n                  </div> before the next one.
# Let's find Omset
omset_pat = re.compile(r'<div style="flex: 1; min-width: 240px;.*?Omset Hari Ini.*?</div>\s*</div>\s*</div>', re.DOTALL)
html = omset_pat.sub("""<div style="flex: 1; min-width: 240px; border-radius: 20px; padding: 24px 20px; background: #ffffff; border: 1px solid #f1f5f9; box-shadow: 0 4px 15px -3px rgba(0,0,0,0.03); display: flex; align-items: center; gap: 16px; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 10px 25px -5px rgba(0,0,0,0.05)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px -3px rgba(0,0,0,0.03)';">
...
# Laba Kotor
kotor_pat = re.compile(r'<div style="flex: 1; min-width: 240px;.*?Laba Kotor.*?</div>\s*</div>\s*</div>', re.DOTALL)
html = kotor_pat.sub("""<div style="flex: 1; min-width: 240px; border-radius: 20px; padding: 24px 20px; background: #ffffff; border: 1px solid #f1f5f9; box-shadow: 0 4px 15px -3px rgba(0,0,0,0.03); display: flex; align-items: center; gap: 16px; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 10px 25px -5px rgba(0,0,0,0.05)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px -3px rgba(0,0,0,0.03)';">
...
# Beban
beban_pat = re.compile(r'<div style="flex: 1; min-width: 240px;.*?Total Beban.*?</div>\s*</div>\s*</div>', re.DOTALL)
html = beban_pat.sub("""<div style="flex: 1; min-width: 240px; border-radius: 20px; padding: 24px 20px; background: #ffffff; border: 1px solid #f1f5f9; box-shadow: 0 4px 15px -3px rgba(0,0,0,0.03); display: flex; align-items: center; gap: 16px; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 10px 25px -5px rgba(0,0,0,0.05)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px -3px rgba(0,0,0,0.03)';">
...
# Bersih
bersih_pat = re.compile(r'<div style="flex: 1; min-width: 240px;.*?Laba Bersih.*?</div>\s*</div>\s*</div>', re.DOTALL)
html = bersih_pat.sub("""<div style="flex: 1; min-width: 240px; border-radius: 20px; padding: 24px 20px; background: #ffffff; border: 1px solid #f1f5f9; box-shadow: 0 4px 15px -3px rgba(0,0,0,0.03); display: flex; align-items: center; gap: 16px; transition: all 0.3s ease;" onmouseover="this.style.transform='translateY(-2px)'; this.style.boxShadow='0 10px 25px -5px rgba(0,0,0,0.05)';" onmouseout="this.style.transform='translateY(0)'; this.style.boxShadow='0 4px 15px -3px rgba(0,0,0,0.03)';">
